...
- `ds25`-`ds36`: AEDP aggregation-level datasets generated by `../notebooks/03_aedp_aggregation_level/1_build_aedp_site_30min_checkpoints.ipynb` and `../notebooks/03_aedp_aggregation_level/2_generate_aedp_aggregation_datasets.ipynb`, with 3 samples per aggregation level.
